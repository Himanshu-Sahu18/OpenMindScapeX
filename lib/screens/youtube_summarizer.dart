...
class _YoutubeSummarizerState extends State<YoutubeSummarizer> {
  ...
  void onPress() async {
    ...
    var url = Uri.parse(
        "https://youtube-summarizer-by-chatgpt.p.rapidapi.com/ytsummary1/?url=$enteredUrl&key=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");
    final header = {
      'X-RapidAPI-Key': "829f610e07msh5b86c50fff2e48ep17dcafjsn5ecf2a56e281",
